...
<div class="container">
  <?php if(have_posts()) : ?>
    <div class="d-flex flex-column justify-content-center align-items-start" style="max-width: 1000px; margin: 0 auto;">
      <h1 class="page-title">Поиск по запросу: <?php echo get_search_query(); ?></h1>
    </div>
    ...
    <?php else:  ?> 
    <h1 class="page-title">По запросу <b class="text-danger"><?php echo get_search_query(); ?></b> ничего не найдено...</h1>
  <?php endif; ?>
</div>
